...
void prisma (GLuint textura1, GLuint textura2,float a, float b, float c)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(a, 1.0f); glVertex3fv(vertice[4]);
		...
		glBegin(GL_POLYGON);	//Right
			...
			glTexCoord2f(a, 1.0f); glVertex3fv(vertice[5]);
		...
		glBegin(GL_POLYGON);	//Back
			...
			glTexCoord2f(a, 1.0f); glVertex3fv(vertice[6]);
		...
		glBegin(GL_POLYGON);  //Left
			...
			glTexCoord2f(a, 1.0f); glVertex3fv(vertice[7]);
		...
		glBegin(GL_POLYGON);  //Bottom
			...
			glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(a, 0.0f); glVertex3fv(vertice[1]);
			glTexCoord2f(a, 1.0f); glVertex3fv(vertice[2]);
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPushMatrix(); 
			...
			prisma(t_piedra.GLindex, t_madera.GLindex, 3.0, 5.0, 3.0); //Estamos asignando la textura ladrillo
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma(t_piedra.GLindex, t_madera.GLindex, 1.0, 1.0, 1.0); //Estamos asignando la textura madera
		glPopMatrix();
		...
		glPushMatrix();
			...
			glColor3f(1.0, 1.0, 1.0);
			glScalef(26.0, 13.0, 1.0);
			prisma(t_madera2.GLindex, t_madera2.GLindex,3.0,5.0, 3.0); //Estamos asignando la textura madera
		glPopMatrix();

		//********Pared trasera************		
		glPushMatrix();
			glTranslatef(0.0f, 8.5f, -15.0f);
			glColor3f(1.0, 1.0, 1.0);
			glScalef(26.0, 13.0, 1.0);
			prisma(t_madera2.GLindex, t_madera2.GLindex, 3.0, 5.0, 3.0); //Estamos asignando la textura madera
		glPopMatrix();
		...
		//********Pared derecha************		
		glPushMatrix();
			glTranslatef(12.5f, 8.5f, -2.5f);
			glColor3f(1.0, 1.0, 1.0);
			glScalef(1.0, 13.0, 24.0);
			prisma(t_madera2.GLindex, t_madera2.GLindex, 3.0, 5.0, 3.0); //Estamos asignando la textura madera
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma(t_madera2.GLindex, t_techo.GLindex, 5.0, 3.0, 2.0); //Estamos asignando la textura madera
		glPopMatrix();

		//********Puerta************		
		glPushMatrix();
			glTranslatef(0.0f, 7.0f, 10.25f);
			glColor3f(1.0, 1.0, 1.0);
			glScalef(4.0, 10.0, 1.0);
			prisma(t_puerta.GLindex, t_puerta.GLindex, 1.0, 1.0, 1.0); //Estamos asignando la textura madera
		glPopMatrix();

		//********Ventana 1************		
		glPushMatrix();
			glTranslatef(-9.0f, 9.5f, 10.20f);
			glColor3f(1.0, 1.0, 1.0);
			glScalef(5.0, 5.0, 1.0);
			prisma(t_ventana.GLindex, t_ventana.GLindex, 1.0, 1.0, 1.0); //Estamos asignando la textura madera
		glPopMatrix();
		...
		//********Ventana 7************		
		glPushMatrix();
			glTranslatef(12.70f, 9.5f, -10.0f);
			glColor3f(1.0, 1.0, 1.0);
			glScalef(1.0, 5.0, 5.0);
			prisma(t_ventana.GLindex, t_ventana.GLindex, 1.0, 1.0, 1.0); //Estamos asignando la textura madera
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma(t_madera.GLindex, t_madera.GLindex, 1.0, 1.0, 1.0); //Estamos asignando la textura madera
		glPopMatrix();
